...
public interface NoticeService extends IService<NoticeEntity> {
    ...
    Integer selectNoReadNoticeD(Authentication authentication);

    ResultUtil clickS(Authentication authentication);

    ResultUtil clickD(Authentication authentication);
}
